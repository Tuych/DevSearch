...
class Message(models.Model):
    ...
    recipient = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True, related_name='messages')  # related_name 1 ta modelda 2 ta colunm 1 ta modelga bog'langan bulsa obratniy svyaz qilish uchun realted name dagi nom orqali qilinadi.shunda condlikt bulmaydi
    name = models.CharField(max_length=200, blank=True)
    email = models.EmailField(max_length=200, blank=True)
    ...
    class Meta:
        ordering = ['is_read', '-created']  # avval is_read false lar chiqadi ,is_read 1 xil bulsa created teskari tartibda saralaydi
